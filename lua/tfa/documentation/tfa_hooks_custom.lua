...
TFA_PreCanAttach(wepom, attid) --can we attach a thingy?  called before exclusions/dependencies/etc
TFA_PreCanDetach(wepom, attid) --can we detach a thingy?  called before exclusions/dependencies/etc
TFA_CanAttach(wepom, attid) --can we attach a thingy?  called after exclusions/dependencies/etc
TFA_CanDetach(wepom, attid) --can we detach a thingy?  called after exclusions/dependencies/etc
