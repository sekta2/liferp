...
--Range Related
SWEP.Primary.Range = 16 * 250 -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/tfa_ins2/c_usp_match.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_ins2/w_usp_match.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2, 0, 0.4)
...
SWEP.Attachments = {
	...
	[5] = { offset = { 0, 0 }, atts = { "ins2_usp_chrome" }, order = 4 },
}
