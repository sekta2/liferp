...
SWEP.Primary.KickHorizontal = 1.2 -- This is the maximum sideways recoil (no real term)
...
SWEP.Attachments = {
	[2] = { offset = { 0, 0 }, atts = { "am_match", "am_magnum", "am_gib" }, order = 1 },
	[4] = { offset = { 0, 0 }, atts = { "ins2_mag_speedloader" }, order = 1 },
}
