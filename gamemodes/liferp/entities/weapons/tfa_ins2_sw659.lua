...
SWEP.PrintName				= "S&W 659"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.SpreadIncrement = 1.1 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery = 6 --How much the spread recovers, per second. Example val: 3
--Range Related
SWEP.Primary.Range = 0.025 * (3280.84 * 16) -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
SWEP.Attachments = {
	...
	[3] = { atts = { "am_match", "am_magnum" }, order = 3 },
	[6] = { atts = { "ins2_ub_laser" }, order = 2 },
}
